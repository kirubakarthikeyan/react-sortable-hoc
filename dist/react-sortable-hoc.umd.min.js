                    ...
                    if (r) {
                      var e = function() {
                          var e,
                            ...
                            f = b({index: l, node: T, collection: k});
                          if (
                            ((R.node = T),
                            (R.margin = c),
                            (R.gridGap = u),
                            ...
                            (R.helper = R.helperContainer.appendChild(
                              ...
                              (s = r.cloneNode(!0)),
                              N(s.querySelectorAll(i)).forEach(function(e, t) {
          ...
          f(n, [
            ...
            },
            {
              ...
              value: function() {
                ...
                console.log(u);
                for (var T = 0, k = i.length; T < k; T++) {
                  var I = this.props.transitionDuration;
                  I && (u[T] = D({}, u[T], L(I))), M(i[T].node, u[T]);
                }
